...
class TwoLayerNet(object):
    ...
    def softmax_loss(self, W, X, y, reg, b = 0):
        """
        ...
        dscores = exp_score / exp_sum.reshape(-1, 1)
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        softmax_loss2, dscores = self.softmax_loss(W2, A1, y, reg, b2)
        loss = softmax_loss2 + 0.5 * reg * (np.sum(W1 * W1))
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
